...
@section('content')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="tabla_tipos_consumibles" class="table table-striped table-hover table-bordered">
                                <thead class="thead">
                                    <tr>
                                        <th>Nro.</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('tipo-consumibles.destroy',$tipoConsumible->id) }}" method="POST">
                                                    ...
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="button" class="btn btn-danger btn-sm delete-button" data-delete-url="{{ route('tipo-consumibles.destroy', $tipoConsumible->id) }}">
    ...
    $(document).ready( function () {
        $('#tabla_tipos_consumibles').DataTable({
            language: {
                "decimal":        ",",
